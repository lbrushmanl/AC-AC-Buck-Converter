...
Test Mains set to ~240Vrms ouput set to ~120Vrms load is 48R.
Capture of load current (Dark blue) Output voltage (Yellow) Switch node (Light blue) (Purple is from the AUX transfomer used by the control circuit).
<img width="1024" height="600" alt="RigolDS34" src="https://github.com/user-attachments/assets/6546d70d-3346-498e-98f3-4ae5063d4a13" />
